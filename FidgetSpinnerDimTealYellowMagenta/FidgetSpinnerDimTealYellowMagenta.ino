...
colorCombo colors[] = {
  ...
  { .primary = 0xFFFF00, .secondary = 0x000000 },  // Red to black
  { .primary = 0xFF00FF, .secondary = 0x000000 },  // Green to black
  { .primary = 0x00FFFF, .secondary = 0x000000 },  // Blue to black
  { .primary = 0xFFFF00, .secondary = 0x00FFFF },  // Red to green
  { .primary = 0xFF00FF, .secondary = 0x00FFFF },  // Red to blue
  { .primary = 0x00FFFF, .secondary = 0xFF00FF }   // Green to blue
};
