...
void setup() {
 ...
 myRTC.setDS1302Time(00, 43, 14, 5, 26, 12, 2019);  //Here you write your actual time/date as shown above 
...
void loop() {
  ...
  Serial.print(myRTC.dayofmonth + "/" + myRTC.month);             //You can switch between day and month if you're using American system
  Serial.print("/");
